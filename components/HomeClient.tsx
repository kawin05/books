...
const libraryImages = [
  ...
  {
    src: '/library-ireland.jpg',
    alt: 'Historic long library hall in Ireland with arched ceiling and bookshelves',
  },
  {
    src: '/library-istock1.jpg',
    alt: 'Grand circular library with towering shelves and skylight',
  },
  {
    src: '/library-istock2.jpg',
    alt: 'Ornate classical library with wooden galleries and arched windows',
  },
]
